...
function Home() {
    ...
    async function saveBlobAsFile(url, fileName) {
...
و نسعد بتقديم تصميم التهنئة بهوية أستروفيل.
                        </p>
                    </div>
                    ...
                    <input type="name" name="name" id="getName" placeholder="الأسم"/>
                        ...
                        <div className="creat">
                        <button  onClick={() => saveBlobAsFile(`${cardWidth}`, `${document.getElementById("getName").value}`)}>إنشاء البطاقة</button>
                        </div>
                ...
                <div className="img-from-bottom-right">
                    ...
                    <div className="social">
                        <h4>انتسب إلينا</h4>
                        <ul>
                            <li> <a href="https://www.youtube.com/channel/UChaP5I6GcKi8MnfIGbT9UOA" target="_blank"><img src={iconYout} alt="youtube"/></a> </li>
                            <li> <a href="https://t.me/Ar_Astrophile" target="_blank"><img src={iconTelegram} alt="telegram"/></a> </li>
                            <li> < a href="https://mobile.twitter.com/astrophile_ar" target="_blank"><img src={iconTwiter} alt="twitter"/></a> </li>
                        </ul>
                    </div>
                </div>
